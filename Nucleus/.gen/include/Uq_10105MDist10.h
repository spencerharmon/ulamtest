...
/***********************         DO NOT EDIT        ******************************
*
* MDist.h - Quark header for ULAM //gcnl:SymbolClass.cpp:750
*
**********************************************************************************
...
//! MDist.ulam:13:   typedef Unsigned(6) Index;
    ...
    Ui_Ut_10161u<EC> Uf_9213getFirstIndex(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_10131u<EC>& Uv_6radius) const; //native //gcnl:SymbolFunction.cpp:459

    Ui_Ut_10161u<EC> Uf_9212getLastIndex(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_10131u<EC>& Uv_6radius) const; //native //gcnl:SymbolFunction.cpp:459

    Ui_Ut_10161u<EC> Uf_9216getFirstESLIndex(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_10151u<EC>& Uv_919eslRadius) const; //native //gcnl:SymbolFunction.cpp:459

    Ui_Ut_10161u<EC> Uf_9215getLastESLIndex(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_10151u<EC>& Uv_919eslRadius) const; //native //gcnl:SymbolFunction.cpp:459
