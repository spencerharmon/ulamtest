...
/***********************         DO NOT EDIT        ******************************
*
* DebugUtils.h - Quark header for ULAM //gcnl:SymbolClass.cpp:750
*
**********************************************************************************
...
//! DebugUtils.ulam:27:   constant Bits cPRINT_EVERYTHING = Unsigned.maxof;
    ...
    void Uf_5print(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102961a<EC>& Uv_3arg) const; //gcnl:SymbolFunction.cpp:463

    void Uf_5print(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102961a<EC>& Uv_1a, Ui_Ut_102321t<EC>& Uv_5flags) const; //native //gcnl:SymbolFunction.cpp:459
    ...
    void Uf_5print(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_10131b<EC>& Uv_3arg) const; //native //gcnl:SymbolFunction.cpp:459

    void Uf_5print(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321u<EC>& Uv_3arg) const; //native //gcnl:SymbolFunction.cpp:459

    Ui_Ut_10111b<EC> Uf_9214hasEventWindow(const UlamContext<EC>& uc, UlamRef<EC>& ur) const; //native //gcnl:SymbolFunction.cpp:459

    void Uf_9212printContext(const UlamContext<EC>& uc, UlamRef<EC>& ur) const; //gcnl:SymbolFunction.cpp:463

    void Uf_9212printContext(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321t<EC>& Uv_5flags) const; //native //gcnl:SymbolFunction.cpp:459

    void Uf_919printChar(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_10181u<EC>& Uv_3arg) const; //native //gcnl:SymbolFunction.cpp:459

    void Uf_6assert(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_10111b<EC>& Uv_1b) const; //native //gcnl:SymbolFunction.cpp:459
