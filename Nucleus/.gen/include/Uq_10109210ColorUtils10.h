...
/***********************         DO NOT EDIT        ******************************
*
* ColorUtils.h - Quark header for ULAM //gcnl:SymbolClass.cpp:750
*
**********************************************************************************
...
//! ColorUtils.ulam:6:   typedef Channel ARGB[4];
    ...
    Ui_Ut_14181u<EC> Uf_5color(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_10181t<EC>& Uv_3red, Ui_Ut_10181t<EC>& Uv_5green, Ui_Ut_10181t<EC>& Uv_4blue) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_14181u<EC> Uf_5color(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321i<EC>& Uv_3hex) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_14181u<EC> Uf_5color(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321u<EC>& Uv_3hex) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_14181u<EC> Uf_5color(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321t<EC>& Uv_3hex) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_14181u<EC> Uf_6modify(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_14181u<EC>& Uv_4this, Ui_Ut_102321u<EC>& Uv_7percent) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_14181u<EC> Uf_8brighter(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_14181u<EC>& Uv_4than) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_14181u<EC> Uf_6dimmer(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_14181u<EC>& Uv_4than) const; //gcnl:SymbolFunction.cpp:463
