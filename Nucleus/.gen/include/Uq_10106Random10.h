...
/***********************         DO NOT EDIT        ******************************
*
* Random.h - Quark header for ULAM //gcnl:SymbolClass.cpp:750
*
**********************************************************************************
...
namespace MFM{
  ...
  struct Uq_10106Random10 : public UlamQuark<EC> /*, Uq_10106UrSelf10 */
  {
    ...
    Ui_Ut_10111b<EC> Uf_5oneIn(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321u<EC>& Uv_4odds) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_102321u<EC> Uf_4bits(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321i<EC>& Uv_3max) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_102321u<EC> Uf_4bits(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321u<EC>& Uv_8bitCount) const; //native //gcnl:SymbolFunction.cpp:459

    Ui_Ut_102321u<EC> Uf_6create(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321i<EC>& Uv_3max) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_102321u<EC> Uf_6create(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321u<EC>& Uv_3max) const; //native //gcnl:SymbolFunction.cpp:459

    Ui_Ut_102321i<EC> Uf_7between(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321i<EC>& Uv_2lo, Ui_Ut_102321i<EC>& Uv_2hi) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_10111b<EC> Uf_6oddsOf(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321i<EC>& Uv_8thisMany, Ui_Ut_102321i<EC>& Uv_9213outOfThisMany) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_10111b<EC> Uf_6oddsOf(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321u<EC>& Uv_8thisMany, Ui_Ut_102321u<EC>& Uv_9213outOfThisMany) const; //gcnl:SymbolFunction.cpp:463
