...
namespace MFM{
  ...
  template<class EC>
  Uq_10109211SiteVisitor10<EC>::Uq_10109211SiteVisitor10() : UlamQuark<EC>(MFM_UUID_FOR("Uq10109211SiteVisitor10", 0))
  { }

  template<class EC>
  Uq_10109211SiteVisitor10<EC>::~Uq_10109211SiteVisitor10(){} //gcnl:NodeBlockClass.cpp:1784

  //BUILT-IN FUNCTIONS:

  template<class EC>
  const UlamClassDataMemberInfo & Uq_10109211SiteVisitor10<EC>::GetDataMemberInfo(u32 dataMemberNumber) const
  {
  ...
  template<class EC>
  s32 Uq_10109211SiteVisitor10<EC>::GetDataMemberCount() const
  {
    return 0; //gcnl:NodeBlockClass.cpp:2720
  } //GetDataMemberCount

  template<class EC>
  const char * Uq_10109211SiteVisitor10<EC>::GetMangledClassName() const
  {
    return "Uq_10109211SiteVisitor10"; //gcnl:NodeBlockClass.cpp:2771
  } //GetMangledClassName

  template<class EC>
  u32 Uq_10109211SiteVisitor10<EC>::GetClassLength( ) const
  {
    return 0; //gcnl:NodeBlockClass.cpp:2019
  } //getClassLength

  template<class EC>
  const unsigned char * Uq_10109211SiteVisitor10<EC>::GetString(u32 sidx)  const
  {
  ...
  template<class EC>
  u32 Uq_10109211SiteVisitor10<EC>::GetStringLength(u32 sidx)  const
  {
    return *(GetString(sidx) - 1); //gcnl:NodeBlockClass.cpp:2603
  } //GetStringLength

  template<class EC>
  u32 Uq_10109211SiteVisitor10<EC>::getDefaultQuark( ) const
  {
    return 0x0; //=0 //gcnl:NodeBlockClass.cpp:2169
  } //getDefaultQuark

  template<class EC>
  VfuncPtr Uq_10109211SiteVisitor10<EC>::m_vtable[3] = {
...
&UlamClass<EC>::PureVirtualFunctionCalled
  ...
  template<class EC>
  VfuncPtr Uq_10109211SiteVisitor10<EC>::getVTableEntry(u32 idx) const
  {
  ...
  template<class EC>
  bool Uq_10109211SiteVisitor10<EC>::internalCMethodImplementingIs(const UlamClass<EC> * cptrarg) const
  {
