...
/***********************         DO NOT EDIT        ******************************
*
* SiteVisitor.h - Quark header for ULAM //gcnl:SymbolClass.cpp:750
*
**********************************************************************************
...
#ifndef UQ_10109211SITEVISITOR10_H
#define UQ_10109211SITEVISITOR10_H

#include "UlamDefs.h"
#include "Uq_10109211SiteVisitor10_Types.h"
...
namespace MFM{
  ...
  struct Uq_10109211SiteVisitor10 : public UlamQuark<EC> /*, Uq_10106UrSelf10 */
  {
    ...
    Uq_10109211SiteVisitor10(); //gcnl:NodeBlockClass.cpp:1377
    ~Uq_10109211SiteVisitor10(); //gcnl:NodeBlockClass.cpp:1382

    static Uq_10109211SiteVisitor10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1388

//! SiteVisitor.ulam:10:   typedef EventWindow.SiteNum SiteNum;

    static void Uf_5visit(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Un_r10412489213WindowScanner10<EC>& Ur_2ws, Ui_Ut_r102961a<EC>& Ur_1a, Ui_Ut_10161u<EC>& Uv_2sn); //virtual //gcnl:SymbolFunction.cpp:451
  ...
  template<class EC>
  Uq_10109211SiteVisitor10<EC> Uq_10109211SiteVisitor10<EC>::THE_INSTANCE;



} //MFM

#include "Uq_10109211SiteVisitor10.tcc"
#endif //UQ_10109211SITEVISITOR10_H
