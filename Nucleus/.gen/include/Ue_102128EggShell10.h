...
#ifndef UE_102128EGGSHELL10_H
#define UE_102128EGGSHELL10_H

#include "UlamDefs.h"
#include "Ue_102128EggShell10_Types.h"
...
namespace MFM{
  ...
  template<class EC>
  class Ue_102128EggShell10 : public UlamElement<EC> /*, Uq_10106UrSelf10 */  {
  ...
  public:
    ...
    Ue_102128EggShell10(); //gcnl:NodeBlockClass.cpp:1441
    ~Ue_102128EggShell10(); //gcnl:NodeBlockClass.cpp:1446

    static Ue_102128EggShell10 THE_INSTANCE; //gcnl:NodeBlockClass.cpp:1452
...
//! EggShell.ulam:21: 	Bool shellComplete;
    typedef UlamRefFixed<EC, 11u, 1u> Up_Um_9213shellComplete; //gcnl:NodeVarDeclDM.cpp:1095
    ...
    void Uf_9211onChildCell(const UlamContext<EC>& uc, UlamRef<EC>& ur) const; //gcnl:SymbolFunction.cpp:463

    void Uf_9214createNeighbor(const UlamContext<EC>& uc, UlamRef<EC>& ur) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_10111b<EC> Uf_9214iHaveNeighbors(const UlamContext<EC>& uc, UlamRef<EC>& ur) const; //gcnl:SymbolFunction.cpp:463

    Ui_Ut_102961a<EC> Uf_9211getNeighbor(const UlamContext<EC>& uc, UlamRef<EC>& ur) const; //gcnl:SymbolFunction.cpp:463

    void Uf_9217guessThatImAnEdge(const UlamContext<EC>& uc, UlamRef<EC>& ur) const; //gcnl:SymbolFunction.cpp:463

    void Uf_9221checkForShellComplete(const UlamContext<EC>& uc, UlamRef<EC>& ur) const; //gcnl:SymbolFunction.cpp:463
  ...
  template<class EC>
  Ue_102128EggShell10<EC> Ue_102128EggShell10<EC>::THE_INSTANCE;



} //MFM

#include "Ue_102128EggShell10.tcc"
#endif //UE_102128EGGSHELL10_H
