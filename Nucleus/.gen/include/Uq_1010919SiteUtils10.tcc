...
namespace MFM{
  ...
  template<class EC>
  Uq_1010919SiteUtils10<EC>::Uq_1010919SiteUtils10() : UlamQuark<EC>(MFM_UUID_FOR("Uq1010919SiteUtils10", 0))
  { }

  template<class EC>
  Uq_1010919SiteUtils10<EC>::~Uq_1010919SiteUtils10(){} //gcnl:NodeBlockClass.cpp:1784

  //BUILT-IN FUNCTIONS:

  template<class EC>
  const UlamClassDataMemberInfo & Uq_1010919SiteUtils10<EC>::GetDataMemberInfo(u32 dataMemberNumber) const
  {
  ...
  template<class EC>
  s32 Uq_1010919SiteUtils10<EC>::GetDataMemberCount() const
  {
    return 0; //gcnl:NodeBlockClass.cpp:2720
  } //GetDataMemberCount

  template<class EC>
  const char * Uq_1010919SiteUtils10<EC>::GetMangledClassName() const
  {
    return "Uq_1010919SiteUtils10"; //gcnl:NodeBlockClass.cpp:2771
  } //GetMangledClassName

  template<class EC>
  u32 Uq_1010919SiteUtils10<EC>::GetClassLength( ) const
  {
    return 0; //gcnl:NodeBlockClass.cpp:2019
  } //getClassLength

  template<class EC>
  const unsigned char * Uq_1010919SiteUtils10<EC>::GetString(u32 sidx)  const
  {
  ...
  template<class EC>
  u32 Uq_1010919SiteUtils10<EC>::GetStringLength(u32 sidx)  const
  {
    return *(GetString(sidx) - 1); //gcnl:NodeBlockClass.cpp:2603
  } //GetStringLength

  template<class EC>
  u32 Uq_1010919SiteUtils10<EC>::getDefaultQuark( ) const
  {
    return 0x0; //=0 //gcnl:NodeBlockClass.cpp:2169
  } //getDefaultQuark

  template<class EC>
  VfuncPtr Uq_1010919SiteUtils10<EC>::m_vtable[2] = {
    (VfuncPtr) ((typename Uq_10106UrSelf10<EC>::Uf_6behave10) &Uq_10106UrSelf10<EC>::Uf_6behave),
    (VfuncPtr) ((typename Uq_10106UrSelf10<EC>::Uf_8getColor11102321u) &Uq_10106UrSelf10<EC>::Uf_8getColor)
  }; //VTABLE Definition //gcnl:NodeBlockClass.cpp:2342

  template<class EC>
  VfuncPtr Uq_1010919SiteUtils10<EC>::getVTableEntry(u32 idx) const
  {
  ...
  template<class EC>
  bool Uq_1010919SiteUtils10<EC>::internalCMethodImplementingIs(const UlamClass<EC> * cptrarg) const
  {
    if(cptrarg == &Uq_10106UrSelf10<EC>::THE_INSTANCE) return(true); //inherited class, or self (last) //gcnl:NodeBlockClass.cpp:1981
    if(cptrarg == &Uq_1010919SiteUtils10<EC>::THE_INSTANCE) return(true); //inherited class, or self (last) //gcnl:NodeBlockClass.cpp:1981
