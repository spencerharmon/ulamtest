...
/***********************         DO NOT EDIT        ******************************
*
* Fail.h - Quark header for ULAM //gcnl:SymbolClass.cpp:750
*
**********************************************************************************
...
namespace MFM{
  ...
  struct Uq_10104Fail10 : public UlamQuark<EC> /*, Uq_10106UrSelf10 */
  {
    ...
    void Uf_4fail(const UlamContext<EC>& uc, UlamRef<EC>& ur) const; //native //gcnl:SymbolFunction.cpp:459

    void Uf_4fail(const UlamContext<EC>& uc, UlamRef<EC>& ur, Ui_Ut_102321i<EC>& Uv_4code) const; //native //gcnl:SymbolFunction.cpp:459
